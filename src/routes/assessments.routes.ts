    ...
    app.post<{
        ...
        if (!parsedBody.success) {
            return reply.status(400).send({ 
                ...
                details: parsedBody.error.issues });//if validation fails, return a 400 Bad Request response with an error message and details about the validation issues. The parsedBody.error.issues property contains an array of validation errors generated by zod, which can help the client understand what went wrong with their request.
        }
